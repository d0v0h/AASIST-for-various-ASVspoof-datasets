...
def get_database_path(database_path: Path) -> Dict[str, Path]:
    # Return ASVspoof 2019 database path
    ASVspoof5_path = database_path / 'ASVspoof5'

    paths = {}

    # write flac path
    paths["trn_flac_path"] = ASVspoof5_path / "flac_T"
    paths["dev_flac_path"] = ASVspoof5_path / "flac_D"
    paths["eval_flac_path"] = ASVspoof5_path / "flac_E_eval"

    # write meta path
    paths["trn_meta_path"] = (ASVspoof5_path / "ASVspoof5.train.tsv")
    paths["dev_meta_path"] = (ASVspoof5_path / "ASVspoof5.dev.track_1.tsv")
    paths["eval_meta_path"] = (ASVspoof5_path / "ASVspoof5.eval.track_1.tsv")
